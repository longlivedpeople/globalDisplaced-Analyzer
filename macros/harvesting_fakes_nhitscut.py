...
if __name__ == "__main__":
    ...
    DY_fake_DG_nvalid = getObject('fakes_DY2M_ptmin10_sigmapt0p4_chi3/th1fs.root', 'total_DG_numberOfValidHits_clone')
    SI_fake_DG_nvalid_bin1 = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'total_DG_numberOfValidHits_bin1_clone')
    SI_fake_DG_nvalid_bin2 = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'total_DG_numberOfValidHits_bin2_clone')
    SI_fake_DG_nvalid_bin3 = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'total_DG_numberOfValidHits_bin3_clone')
    ...
    SI_fake_DG_nvalid_bins_.addLatex(0.4, 0.5, 'p_{T}^{DG} > 10 GeV, |#eta^{DG}| < 2.4', size = 0.03, align = 11)
    SI_fake_DG_nvalid_bins_.addLatex(0.4, 0.45, '#sigma_{p_{T}}/p_{T} < 0.4, #chi^{2}/ndof < 3', size = 0.03, align = 11)
    SI_fake_DG_nvalid_bins_.save(1, 0, 0, '','', outputDir = WORKPATH + 'harvested_fakes_nhitcut_'+opts.tag+'/')

    # bin1
    SI_matched_DG_nvalid = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'matched_DG_numberOfValidHits_bin1')
    SI_unmatched_DG_nvalid = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'unmatched_DG_numberOfValidHits_bin1')
    ...
    SI_DG_nvalid_.addLatex(0.17, 0.81, 'p_{T}^{DG} > 10 GeV, |#eta^{DG}| < 2.4', size = 0.03, align = 11)
    SI_DG_nvalid_.addLatex(0.17, 0.76, '#sigma_{p_{T}}/p_{T} < 0.4, #chi^{2}/ndof < 3', size = 0.03, align = 11)
    ...
    # bin2
    SI_matched_DG_nvalid = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'matched_DG_numberOfValidHits_bin2')
    SI_unmatched_DG_nvalid = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'unmatched_DG_numberOfValidHits_bin2')
    SI_DG_nvalid = doFakeStack(SI_matched_DG_nvalid, SI_unmatched_DG_nvalid)
    ...
    # bin3
    SI_matched_DG_nvalid = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'matched_DG_numberOfValidHits_bin3')
    SI_unmatched_DG_nvalid = getObject('fakes_signal_ptmin10_sigmapt0p4_chi3/th1fs.root', 'unmatched_DG_numberOfValidHits_bin3')
    SI_DG_nvalid = doFakeStack(SI_matched_DG_nvalid, SI_unmatched_DG_nvalid)
    SI_DG_nvalid.SetMinimum(1)
    SI_DG_nvalid.SetMaximum(5e6)
