...
if __name__ == "__main__":
    ...
    SI_fake_DG_eta_.addRate(SI_fake_DG_eta_nocut, 'AP', 'No p_{T}^{DG} cut', 'p', r.kBlack, True, 0, marker = 27)
    ...
    SI_fake_DG_eta_.addRate(SI_fake_DG_eta_ptmin31, 'AP, SAME', 'p_{T}^{DG} > 31 GeV', 'p', r.kRed-4, True, 3, marker = 24)
